...
When bug is found or new feature/suggestion proposed, [new Issue gets created](https://github.com/ghost-coin/falcon-desktop/issues). Our repo has predefined Issue template to help you started with that (the more info you provide the better).
...
When your code is complete and ready, [submit new Pull Request](https://github.com/ghost-coin/falcon-desktop/compare).
...
- **Icons**
  - all available icons are in [`/src/assets/icons/SVG`](https://github.com/ghost-coin/falcon-desktop/tree/dev/src/assets/icons/SVG)
